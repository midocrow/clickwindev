                ...
                <div class="columns">
                    <div class="column is-three-quarters">
                        <p id="war" align="justify" style="font-size:12px;">
                            - If you wish to add another subscription and your first subscription has not expired, there is
                    ...
                    <div class="column">
                        <img id="img" style="margin: 26%" src="/storage/warning-sign.png" width="85px" />
                    </div>
                </div>
            </div>
        </article>
