@extends('layouts.ap') @section('content')
    ...
    <div class="home" style="background-image: linear-gradient(160deg, rgba(0,0,0,1) 0%, rgba(255,212,25,1) 100%);">
                    ...
                    <div class="columns">
                        <div class="column is-6 is-offset-1">
                            <div style="border: 5px solid white;border-radius:10px;">
                                ...
                                <video id="video" src="/storage/cw-intro.mp4" controls></video>
                            </div>
                        </div>
        ...
        <section class="section hero" style="min-height: 0vh;">
            <div class="hero-body is-black">
                <div class="container has-text-centered">
                    ...
                    <div class="columns">
                        ...
                        <div class="column is-half" style="margin-top:5%;">
                    ...
                    <div class="columns">
                        ...
                        <div class="column is-half"><img src="/storage/undraw_pitching.svg"></div>
                        ...
                        <div class="columns">
                            ...
                            <div class="column">
                                ...
                                <div class="columns ">
                                    <div class="column">
                                        <div data-aos="fade-in">
                                            <figure style="float:right;" class="image is-128x128">
                                                <img src="/storage/undraw_real_time.svg">
                                            </figure>

                                        </div>
                                    </div>
                                    <div class="column">
                                        <h5 style="padding-top:10%;" class="title is-5 is-spaced">Community collaboration
                                        </h5>
                            ...
                            <div class="column">
                                ...
                                <div class="columns ">
                                    <div class="column">
                                        <div data-aos="fade-in">
                                            <figure style="float:right;" class="image is-128x128">
                                                <img src="/storage/undraw_confirmed.svg">
                                            </figure>

                                        </div>
                                    </div>
                                    <div class="column">
                                        <h5 align="left" style="padding-top:13%;" class="title is-5 is-spaced">Pure content
                                        </h5>
                            ...
                            <div class="column">
                                ...
                                <div class="columns">
                                    <div class="column">
                                        <div data-aos="fade-in">
                                            <figure style="float:right;" class="image is-128x128">
                                                <img src="/storage/undraw_accept_terms.svg">
                                            </figure>

                                        </div>
                                    </div>
                                    <div class="column">
                                        <h5 align="left" style="padding-top:13%;" class="title is-5 is-spaced"> Following
                                            instructions </h5>
                            ...
                            <div class="column">
                                ...
                                <div class="columns ">
                                    <div class="column">
                                        <div data-aos="fade-in">
                                            <figure style="float:right;" class="image is-128x128">
                                                <img src="/storage/undraw_working.svg">
                                            </figure>

                                        </div>
                                    </div>
                                    <div class="column">
                                        <h5 align="left" style="padding-top:13%;" class="title is-5 is-spaced">Daily work
                                        </h5>
