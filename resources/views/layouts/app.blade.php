...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Bangers|Bitter:700|Crete+Round|Titillium+Web|Anton" rel="stylesheet" data-n-head="true">
    <!-- Styles -->
    ...
    <div id="app">
        ...
        <section class="hero is-dark is-fullheight">
            ...
            <div class="hero-head">
                ...
                @endguest
                @auth
                <navbar logged="{{  true }}" rank="{{ Auth::user()->rank }}" zone="{{ App\Link::where('user_id',Auth::id())->first()->zone }}" notifs="{{ Auth::user()->notifications }}" avatar="{{ Auth::user()->avatar }}">
                    {{ csrf_field() }}
                </navbar>
                @endauth
            </div>
