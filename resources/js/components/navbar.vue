<template>
    ...
    >
        ...
        <div
            ...
            :class="showNav ? 'navbar-menu  is-active' : 'navbar-menu'"
        >
            <div class="navbar-start">
                <a v-if="logged" class="navbar-item" href="/home" id="item"
                    >Win Zones</a
                >
                ...
                <a
                    ...
                    >Add link</a
                >
                <a v-if="logged" class="navbar-item" href="/store" id="item"
                    >Premium & Cwins</a
                >

                <div class="navbar-item has-dropdown is-hoverable">
                    <a v-if="logged" class="navbar-link is-arrowless" id="item"
                        >Free Cwins</a
                    >

                    <div class="navbar-dropdown">
                        <a class="navbar-item" href="/free" id="item"
                            >Refer & Win</a
                        >
                        <a class="navbar-item" href="/coupon" id="item"
                            >Coupon code</a
                        >
                    </div>
                </div>
                    ...
                    <div class="dropdown is-active is-right">
                        <div class="dropdown-trigger" v-if="logged">
                            <span
                                ...
                                class="icon is-left is-large"
                            >
                                <span
                                    class="has-badge-rounded has-badge-outlined has-badge-danger"
                                    style="background-color:unset;margin-bottom:-8px;"
                                    data-badge="8"
                                    id="notifi"
                                >
                                    <i
                        ...
                        >
                            <div
                                ...
                                style=" overflow-x: hidden;background-color:black;margin-top:20px;border-radius:10px;  box-shadow: 0 1px 4px 0 #ffd419, 0 4px 4px 0 rgba(0, 0, 0, 0.19);"
                            >
                                    ...
                                    <div class="dropdown-item">
                                        <div class="columns">
                                            ...
                                            <div class="column is-9">
                                                <p>
                                                    This user was kicked out?
                                                    and he has reclaimed many
                                                    things
                                                </p>

                                                <p
                                                    style="margin-top:10px;color:grey;font-weight:lighter;font-family:arial;"
                                                >
                                                    6 min ago
                                                </p>
                                            </div>
