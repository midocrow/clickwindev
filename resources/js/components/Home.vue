<template>
    <section class>
        <div class>
            <span class="has-text-light has-text-weight-bold is-size-1"
                >Your link</span
            >
            <br />
            <br />
                    ...
                    <div v-if="edit === false && currentlink !== ''">
                        <div class="field" v-if="currentlink !== ''">
                            ...
                            <div class="control has-icons-right">
                                ...
                                <span
                                    @click="copy()"
                                    class="icon is-right is-medium is-active"
                                >
                    ...
                    <div class="columns">
                        <div class="column is-three-quarters">
                            <p id="war">
                                ...
                                hours. <br />- The ranking link will be updated
